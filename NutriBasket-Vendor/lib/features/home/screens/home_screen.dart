            ...
            return Column(children: [
              ...
              SizedBox(
                  height: !_isNotificationPermissionGranted ||
                      ...
                      : 0),
              Get.find<ProfileController>().modulePermission != null &&
                        ...
                        profileController.profileModel != null
                            ? GetBuilder<OrderController>(
                                ...
                                if (orderController.runningOrders != null) {
                                  for (int i = 0;
                                      i < orderController.runningOrders!.length;
                                      i++) {
                                    if (orderController
                                                .runningOrders?[i].status ==
                                            'confirmed' ||
                                        orderController
                                                .runningOrders?[i].status ==
                                            'cooking' ||
                                        ...
                                        orderController
                                                .runningOrders?[i].status ==
                                            'food_on_the_way') {
                                      if (orderController.runningOrders![i]
              ...
              GetBuilder<OrderController>(builder: (orderController) {
                ...
                return profileController.modulePermission != null
                    ? Get.find<ProfileController>().modulePermission!.order!
                        ? Column(children: [
                            orderController.runningOrders != null
                                ? Container(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemCount:
                                          orderController.runningOrders!.length,
