                    ...
                    children: [
                      Row(children: [
                        ...
                        Column(
                            ...
                            children: [
                              Text(
                                '${'${couponBody.couponType == 'free_delivery' ? 'free_delivery'.tr : couponBody.discountType != 'percent' ? PriceConverterHelper.convertPrice(double.parse(couponBody.discount.toString())) : couponBody.discount}'} ${couponBody.couponType == 'free_delivery' ? '' : couponBody.discountType == 'percent' ? ' %' : ''}'
                          ...
                          return Transform.scale(
                            ...
                            child: CupertinoSwitch(
                              ...
                              trackColor: Theme.of(context)
                                  ...
                                  .withOpacity(0.5),
                              value:
                                  couponController.coupons![index].status == 1
                                      ? true
                                      : false,
                        ...
                        onPressed: () {
                          ...
                          couponController
                            ...
                            if (couponDetails != null) {
                              Get.to(
                                  () => AddCouponScreen(coupon: couponDetails));
                            }
                          });
                        },
