...
class SelectLocationAndModuleViewWidget extends StatefulWidget {
  ...
  const SelectLocationAndModuleViewWidget(
      {super.key,
  ...
  @override
  State<SelectLocationAndModuleViewWidget> createState() =>
      _SelectLocationAndModuleViewWidgetState();
}
...
class _SelectLocationAndModuleViewWidgetState
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AddressController>(builder: (addressController) {
      ...
      if (addressController.zoneList != null &&
          addressController.zoneIds != null) {
        for (int index = 0;
      ...
      bool isRentalModule = widget.fromView &&
          ...
          addressController.moduleList![addressController.selectedModuleIndex!]
                  .moduleType ==
              'rental';
      ...
      return Container(
        ...
        child: SizedBox(
            child: Padding(
          padding:
              EdgeInsets.all(widget.fromView ? 0 : Dimensions.paddingSizeSmall),
            ...
            child:
              ...
              widget.fromView
                  ? ZoneSelectionWidget(
                      ...
                      zoneList: zoneList,
                      callBack: () {
                        _setPolygon(addressController
                            .zoneList![addressController.selectedZoneIndex!]);
                      })
                  : const SizedBox(),
              SizedBox(
                  height:
                      widget.fromView ? Dimensions.paddingSizeExtremeLarge : 0),
              ...
              SizedBox(
                  height: !widget.fromView ? Dimensions.paddingSizeSmall : 0),
              !widget.fromView
                  ? CustomButtonWidget(
  ...
  Widget mapView(AddressController addressController) {
    return addressController.zoneList!.isNotEmpty
        ? Center(
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: Stack(clipBehavior: Clip.none, children: [
                  ...
                  const Center(
                      child: CustomAssetImageWidget(Images.pickStoreMarker,
                          height: 50, width: 50)),
                  Positioned(
                        ...
                        if (position != null) {
                          ...
                          if (!widget.fromView) {
                            ...
                            addressController.setLocation(
                              ...
                              zoneId: addressController
                                  .zoneList![
                                      addressController.selectedZoneIndex!]
                                  .id,
                            );
                          }
                        }
                          ...
                          child: InkWell(
                            onTap: () {
                              Get.to(Scaffold(
                                ...
                                body: SelectLocationAndModuleViewWidget(
                                    fromView: false,
                                    mapController: _mapController),
                              ));
                            },
