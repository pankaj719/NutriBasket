...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.find<ProfileController>().profileModel != null) {
      selfDelivery = Get.find<ProfileController>()
              .profileModel!
              .stores![0]
              .selfDeliverySystem ==
          1;
                                      ...
                                      child: Row(children: [
                                        ...
                                        Text(
                                          order.orderStatus == 'delivered'
                                              ? '${'delivered_at'.tr} ${order.delivered != null ? DateConverterHelper.dateTimeStringToDateTime(order.delivered!) : ''}'
                        ...
                        : showBottomView
                            ? (controllerOrderModel.orderStatus == 'picked_up')
                                ? Container(
                                    ...
                                    alignment: Alignment.center,
                                    child: Text('item_is_on_the_way'.tr,
                                        style: robotoMedium),
                                  )
                                : showSlider
                                    ? (controllerOrderModel.orderStatus ==
