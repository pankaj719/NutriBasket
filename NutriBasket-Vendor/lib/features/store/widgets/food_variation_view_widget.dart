...
class FoodVariationViewWidget extends StatefulWidget {
  ...
  final Item? item;
  const FoodVariationViewWidget(
      {super.key, required this.storeController, required this.item});

  @override
  State<FoodVariationViewWidget> createState() =>
      _FoodVariationViewWidgetState();
}
...
class _FoodVariationViewWidgetState extends State<FoodVariationViewWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      widget.storeController.variationList!.isNotEmpty
          ? ListView.builder(
                ...
                return Stack(children: [
                  Container(
                    ...
                    child: Column(children: [
                      Row(children: [
                        ...
                        Expanded(
                          ...
                          child: CheckboxListTile(
                            value: widget
                                .storeController.variationList![index].required,
                            ...
                            Row(children: [
                              InkWell(
                                ...
                                child: Row(children: [
                                  Radio<bool>(
                                    value: true,
                                    groupValue: widget.storeController
                      ...
                      Visibility(
                        visible: !widget
                            .storeController.variationList![index].isSingle,
                        child: Row(children: [
                          Flexible(
                              child: CustomTextFieldWidget(
                            hintText: 'minimum'.tr,
                  ...
                  Align(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () =>
                            widget.storeController.removeVariation(index),
                      )),
                ]);
              },
            )
          ...
          ? InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius:
                        BorderRadius.circular(Dimensions.radiusSmall)),
                child: Text('add_new_variation'.tr,
                    style: robotoMedium.copyWith(
                        color: Theme.of(context).cardColor,
