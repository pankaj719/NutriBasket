...
class AttributeViewWidget extends StatefulWidget {
  ...
  const AttributeViewWidget(
      {super.key, required this.storeController, required this.product});
...
class _AttributeViewWidgetState extends State<AttributeViewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return InkWell(
              onTap: () =>
                  widget.storeController.toggleAttribute(index, widget.product),
              child: Container(
                width: 100,
              ...
              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    ...
                    Expanded(
                      ...
                      controller: widget
                          .storeController.attributeList![index].controller,
                    ...
                    CustomButtonWidget(
                      onPressed: () {
                        String variant = widget.storeController
                            .attributeList![index].controller.text
                            .trim();
                        if (variant.isEmpty) {
                          showCustomSnackBar('enter_a_variant_name'.tr);
                        } else {
                          widget.storeController.attributeList![index]
                              .controller.text = '';
                          widget.storeController
                              .addVariant(index, variant, widget.product);
                        }
                      },
                      buttonText: 'add'.tr,
                      width: 70,
                  ...
                  Container(
                    ...
                    child: widget.storeController.attributeList![index].variants
                            .isNotEmpty
                        ? ListView.builder(
                            scrollDirection: Axis.horizontal,
                            padding: const EdgeInsets.only(
                                top: Dimensions.paddingSizeExtraSmall),
                            itemCount: widget.storeController
                                .attributeList![index].variants.length,
                            itemBuilder: (context, i) {
                              return Container(
                                ...
                                child: Row(children: [
                                  Text(
                                      widget.storeController
                                          .attributeList![index].variants[i],
                                      style: robotoRegular),
                                  InkWell(
                                    onTap: () => widget.storeController
                                        .removeVariant(
                        ...
                        : Align(
                            ...
                            child: Text('no_variant_added_yet'.tr)),
                  ),
            ...
            child: Column(children: [
              ...
              Row(children: [
                Expanded(
                  ...
                  hintText: 'price'.tr,
                  controller: widget
                      .storeController.variantTypeList![index].priceController,
                  focusNode:
                      widget.storeController.variantTypeList![index].priceNode,
                  nextFocus: stock!
                      ? widget.storeController.variantTypeList![index].stockNode
                      : index !=
                              widget.storeController.variantTypeList!.length - 1
                          ? widget.storeController.variantTypeList![index + 1]
                              .priceNode
                          : null,
                  inputAction: (stock &&
                          index !=
                              widget.storeController.variantTypeList!.length -
                                  1)
                ...
                stock
                    ? Expanded(
                        ...
                        controller: widget.storeController
                            .variantTypeList![index].stockController,
                        focusNode: widget
                            .storeController.variantTypeList![index].stockNode,
                        nextFocus: index !=
                                widget.storeController.variantTypeList!.length -
                                    1
                            ? widget.storeController.variantTypeList![index + 1]
                        ...
                        onChanged: (String text) =>
                            Get.find<StoreController>().setTotalStock(),
                      ))
                    : const SizedBox(),
              ]),
            ]),
      ...
      SizedBox(
          height: widget.storeController.hasAttribute()
              ? Dimensions.paddingSizeLarge
              : 0),
    ]);
  }
