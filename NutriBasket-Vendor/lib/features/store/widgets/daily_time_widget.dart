...
class DailyTimeWidget extends StatelessWidget {
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      GetBuilder<StoreController>(
                                        ...
                                        return storeController.scheduleLoading
                                            ? const Center(
                                                child:
                                                ...
                                                Expanded(
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    if (openingTime == null) {
                                                      ...
                                                      showCustomSnackBar(
                                                          'pick_end_time'.tr);
                                                    } else if (DateConverterHelper
                                                            .convertTimeToDateTime(
                                                                openingTime!)
                                                        .isAfter(DateConverterHelper
                                                            .convertTimeToDateTime(
                                                                openingTime!))) {
                                                      showCustomSnackBar(
                            ...
                            child: InkWell(
                              onTap: () => Get.dialog(
                                  ConfirmationDialogWidget(
                                    icon: Images.warning,
                                    description:
                                        'are_you_sure_to_delete_this_schedule'
                                            .tr,
                                    onYesPressed: () =>
  ...
  bool _isUnderTime(String time, String startTime, String? endTime) {
    return DateConverterHelper.convertTimeToDateTime(time)
            .isAfter(DateConverterHelper.convertTimeToDateTime(startTime)) &&
        DateConverterHelper.convertTimeToDateTime(time)
            .isBefore(DateConverterHelper.convertTimeToDateTime(endTime!));
  }
}
