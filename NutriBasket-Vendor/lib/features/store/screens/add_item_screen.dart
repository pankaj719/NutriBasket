                      ...
                      child: Column(
                          ...
                          children: [
                                  ...
                                  children: [
                                            ...
                                            Expanded(
                                              ...
                                              title: Text('non_veg'.tr,
                                                  style: robotoRegular.copyWith(
                                                      fontSize: Dimensions
                                                          .fontSizeSmall)),
                                              groupValue: storeController.isVeg
                                                  ? 'veg'
                                                  : 'non_veg',
                                              value: 'non_veg',
                                    ...
                                    isPharmacy
                                        ? ListTile(
                                            ...
                                            title: Text('is_basic_medicine'.tr,
                                                style: robotoMedium),
                                            contentPadding: EdgeInsets.zero,
                                            dense: true,
                                            horizontalTitleGap: 0,
                            ...
                            _module.itemAvailableTime!
                                ? Text('availability'.tr, style: robotoBold)
                                : const SizedBox(),
                            SizedBox(
                    ...
                    !storeController.isLoading
                        ? CustomButtonWidget(
                            ...
                            onPressed: () {
                              ...
                              int maxOrderQuantity = _maxOrderQuantityController
                                      .text.isNotEmpty
                              ...
                              if (Get.find<SplashController>()
                                ...
                                for (VariationModelBodyModel variationModel
                                  ...
                                  if (variationModel
                                    ...
                                    } else if (int.parse(variationModel
                                            .minController!.text) <
                                        1) {
                                      variationMinLessThenZero = true;
                                    } else if (int.parse(variationModel
                                            .maxController!.text) <
                                        int.parse(variationModel
                                            .minController!.text)) {
                                    ...
                                    for (Option option
                                      ...
                                      } else if (option.optionPriceController!
                                          .text.isEmpty) {
                              ...
                              if (defaultDataNull) {
                              ...
                              } else if (categoryController.categoryIndex ==
                                  null) {
                                ...
                                _item.categoryIds!.add(CategoryIds(
                                    id: categoryController
                                        ...
                                        .id
                                        .toString()));
                                if (categoryController.subCategoryIndex !=
                                    null) {
                                  _item.categoryIds!.add(CategoryIds(
                                      id: categoryController
                                          .subCategoryList![categoryController
                                              .subCategoryIndex!]
                                          .id
                                          .toString()));
                                } else {
                                ...
                                _item.brandId = storeController.brandList !=
                                            null &&
