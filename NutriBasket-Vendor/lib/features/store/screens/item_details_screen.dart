...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isGrocery = Get.find<ProfileController>()
            .profileModel!
            .stores![0]
            .module!
            .moduleType ==
            ...
            Expanded(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    (isFood || isGrocery) && item.nutrition!.isNotEmpty
                        ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme.of(context).cardColor,
                        ...
                        : const SizedBox(),
                    (isFood || isGrocery) && item.allergies!.isNotEmpty
                        ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme.of(context).cardColor,
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  //     return Container(
                                  //       padding: const EdgeInsets.symmetric(horizontal: 5, vertical: Dimensions.paddingSizeExtraSmall),
                                  //       // margin: const EdgeInsets.only(right: Dimensions.paddingSizeSmall, bottom: Dimensions.paddingSizeSmall),
                                  //       // decoration: BoxDecoration(
                                  //       //   color: Theme.of(context).primaryColor.withOpacity( 0.1),
                                  //       //   borderRadius: BorderRadius.circular(cardRadius),
                        ...
                        : const SizedBox(),
                    isPharmacy && item.genericName!.isNotEmpty
                        ? Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(cardRadius),
                              color: Theme.of(context).cardColor,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                storeController.itemReviewList != null
                                    ? storeController.itemReviewList!.isNotEmpty
                                        ? SizedBox(
                                            height: 150,
