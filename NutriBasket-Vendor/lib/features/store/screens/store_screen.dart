...
class _StoreScreenState extends State<StoreScreen>
  ...
  final bool? _review =
      Get.find<ProfileController>().profileModel!.stores![0].reviewsSection;
    ...
    return GetBuilder<StoreController>(builder: (storeController) {
      return GetBuilder<ProfileController>(builder: (profileController) {
        Store? store = profileController.profileModel != null
            ...
            : null;
        bool isShowingTrialContent = profileController.profileModel != null &&
        ...
        if (profileController.profileModel!.stores![0].storeBusinessModel ==
            'subscription') {
          haveSubscription =
              profileController.profileModel!.subscription?.review == 1;
        } else {
        ...
        return Scaffold(
          ...
          floatingActionButton:
            ...
            return storeController.isFabVisible &&
                    (storeController.tabIndex == 0 &&
                        Get.find<ProfileController>().modulePermission!.item!)
                ? Padding(
                    ...
                    SliverToBoxAdapter(
                      ...
                      child: Column(children: [
                        ...
                        store.discount != null
                            ...
                            : const SizedBox(),
                        SizedBox(
                            height: (store.delivery! && store.freeDelivery!)
                                ? Dimensions.paddingSizeSmall
                                : 0),
                        ...
                        if (_tabController!.index == 0) {
                          ...
                          return haveSubscription
                              ? Get.find<ProfileController>()
                                      .modulePermission!
                                      .reviews!
                                  ? storeController.storeReviewList != null
                                      ? storeController
                                              .storeReviewList!.isNotEmpty
                                          ? ListView.builder(
