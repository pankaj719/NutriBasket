...
class _AnnouncementScreenState extends State<AnnouncementScreen> {
  ...
  @override
  void initState() {
    Get.find<StoreController>().setAnnouncementStatus(
        widget.announcementStatus == 1 ? true : false,
        willUpdate: false);
            ...
            child: CupertinoSwitch(
              ...
              onChanged: (value) {
                showCustomBottomSheet(
                    child: const AnnouncementStatusBottomSheet());
              },
            ),
          ),
        ),
            ...
            Row(children: [
              ...
              JustTheTooltip(
                ...
                content: Padding(
                  ...
                  child: Text(
                      'this_feature_is_for_sharing_important_information_or_announcements_related_to_the_vendor'
                          .tr,
