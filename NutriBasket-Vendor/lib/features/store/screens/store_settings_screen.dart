...
class _StoreSettingsScreenState extends State<StoreSettingsScreen> {
  ...
  void initState() {
    ...
    _minimumDeliveryFeeController.text =
        widget.store.minimumShippingCharge.toString();
    ...
    _extraPackagingController.text =
        widget.store.extraPackagingAmount.toString();
    _minimumStockController.text =
        widget.store.minimumStockForWarning.toString();
    if (widget.store.deliveryTime != null &&
      ...
      try {
        ...
        Get.find<StoreController>().setDurationType(
            Get.find<StoreController>().durations.indexOf(typeList[1]) + 1,
            false);
      } catch (_) {}
    }
    _store = widget.store;
            ...
            Expanded(
              ...
              child: Column(children: [
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: TextFieldWidget(
                        hintText:
                            '${_module.showRestaurantText! ? 'restaurant_name'.tr : 'store_name'.tr}  (${_languageList[index].value!})',
                ...
                Row(children: [
                  ...
                  SizedBox(
                      width: _store.selfDeliverySystem == 1
                ...
                Row(children: [
                  ...
                  Expanded(
                    ...
                    value: storeController.durationIndex.toString(),
                    title: null,
                    dataList: storeController.durations,
                ...
                _module.orderPlaceToScheduleInterval!
                    ...
                    : const SizedBox(),
                SizedBox(
                    height: _module.orderPlaceToScheduleInterval!
                        ? Dimensions.paddingSizeLarge
                        : 0),
                ...
                (_module.vegNonVeg! &&
                    ...
                    ? Row(children: [
                        Expanded(
                            child: InkWell(
                          onTap: () => storeController.setStoreVeg(
                              !storeController.isStoreVeg!, true),
                          child: Row(children: [
                            Checkbox(
                        ...
                        Expanded(
                            child: InkWell(
                          onTap: () => storeController.setStoreNonVeg(
                              !storeController.isStoreNonVeg!, true),
                          child: Row(children: [
                            Checkbox(
                              value: storeController.isStoreNonVeg,
                              onChanged: (bool? isActive) => storeController
                                  .setStoreNonVeg(isActive, true),
                              activeColor: Theme.of(context).primaryColor,
                            ),
                            Text('non_veg'.tr),
                          ]),
                ...
                Row(children: [
                  ...
                  Transform.scale(
                      ...
                      child: CupertinoSwitch(
                        ...
                        activeColor: Theme.of(context).primaryColor,
                        onChanged: (bool isActive) =>
                            storeController.toggleExtraPackaging(),
                      ))
                ]),
                ...
                SizedBox(
                    height:
                        _module.alwaysOpen! ? 0 : Dimensions.paddingSizeLarge),
                ...
                widget.store.module!.moduleType.toString() == 'food'
                    ? SwitchButtonWidget(
                        icon: Icons.flatware,
                        title: 'cutlery'.tr,
                    ...
                    : const SizedBox(),
                SizedBox(
                    height: widget.store.module!.moduleType.toString() == 'food'
                        ? Dimensions.paddingSizeSmall
                        : 0),
                ...
                SizedBox(
                    height:
                        widget.store.module!.moduleType.toString() == 'pharmacy'
                            ? Dimensions.paddingSizeSmall
                            : 0),
                  ...
                  ClipRRect(
                    ...
                    child: storeController.rawCover != null
                        ? GetPlatform.isWeb
                            ...
                            : Image.file(
                                File(storeController.rawCover!.path),
                                width: context.width,
                                height: 170,
                                fit: BoxFit.cover,
                              )
                ...
                ? CustomButtonWidget(
                    ...
                    onPressed: () {
                      ...
                      String deliveryChargePerKm =
                          _deliveryChargePerKmController.text.trim();
                      ...
                      if (defaultNameNull) {
                      ...
                      } else if (storeController.isExtraPackagingEnabled! &&
                          extraPackagingAmount.isEmpty) {
                        showCustomSnackBar(
                            'enter_extra_packaging_amount_more_than_0'.tr);
                      } else if (storeController.isExtraPackagingEnabled! &&
                        ...
                        _store.minimumShippingCharge =
                            double.parse(deliveryFee);
                        _store.maximumShippingCharge = maximumFee.isNotEmpty
                            ? double.parse(maximumFee)
                            : null;
                        ...
                        _store.veg =
                            (_module.vegNonVeg! && storeController.isStoreVeg!)
                                ? 1
                                : 0;
                        _store.nonVeg = (!_module.vegNonVeg! ||
                                storeController.isStoreNonVeg!)
                            ? 1
                            : 0;
                        ...
                        storeController.updateStore(
                            ...
                            maximum,
                            storeController
                                .durations[storeController.durationIndex - 1],
                            translation);
                      }
                    },
