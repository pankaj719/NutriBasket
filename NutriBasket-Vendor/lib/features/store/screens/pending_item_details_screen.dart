...
class PendingItemDetailsScreen extends StatefulWidget {
  ...
  @override
  State<PendingItemDetailsScreen> createState() =>
      _PendingItemDetailsScreenState();
}

class _PendingItemDetailsScreenState extends State<PendingItemDetailsScreen>
  ...
  void initState() {
    ...
    Get.find<StoreController>()
        .getPendingItemDetails(widget.id, canUpdate: false);
      ...
      return Scaffold(
        appBar: AppBar(
          title: Column(children: [
            Text('item_details'.tr,
                style: robotoRegular.copyWith(
                    fontSize: Dimensions.fontSizeLarge,
                    color: Theme.of(context).textTheme.bodyLarge!.color)),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
            Text(
                storeController.pendingItem![0].isRejected == 0
                    ? 'this_item_is_under_review'.tr
                    : 'this_item_has_been_rejected'.tr,
                style: robotoRegular.copyWith(
                    fontSize: Dimensions.fontSizeSmall,
                    color: storeController.pendingItem![0].isRejected == 0
                        ? Colors.blue
          ...
          elevation: 0.4,
          actions: [
            storeController.item != null
                ? IconButton(
                    onPressed: () => Get.find<StoreController>().deleteItem(
                        storeController.item!.id,
                        pendingItem: true),
        ...
        body: storeController.item != null
            ? EnglishLanguageItemTab(
                item: storeController.item!, storeController: storeController)
...
class EnglishLanguageItemTab extends StatelessWidget {
  ...
  const EnglishLanguageItemTab(
      {super.key, required this.item, required this.storeController});
  ...
  Widget build(BuildContext context) {
    ...
    for (Translation translation in item.translations!) {
      if (translation.locale ==
          languageList![storeController.languageSelectedIndex].key) {
            ...
            child: Column(children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      storeController
                                                  .pendingItem![0].isRejected ==
                                              0
                                          ? 'this_item_is_under_review'.tr
                                          : 'this_item_has_been_rejected'.tr,
                                      style: robotoRegular.copyWith(
                                          fontSize: Dimensions.fontSizeSmall,
                                          color: storeController.pendingItem![0]
                                                      .isRejected ==
                                                  0
                                              ? Colors.blue
                                              : Theme.of(context)
              ...
              Column(children: [
                ...
                item.categoryIds!.length > 1
                    ...
                    : const SizedBox(),
                InformationTextWidget(
                  title: storeController.isFoodModule()
                      ? 'available_time'.tr
                      : 'total_stock'.tr,
                  value: storeController.isFoodModule()
              ...
              Column(children: [
                ...
                InformationTextWidget(
                    ...
                    value: item.discountType != 'percent'
                        ? PriceConverterHelper.convertPrice(item.discount)
              ...
              (item.foodVariations != null &&
                  ...
                  ? Column(children: [
                      ...
                      Get.find<SplashController>()
                              ...
                              .newVariation!
                          ? VariationViewForFood(item: item)
                          : VariationViewForGeneral(
                              item: item, stock: module!.stock),
                    ])
                  : const SizedBox(),
              SizedBox(
                  height: (item.foodVariations != null &&
                              item.foodVariations!.isNotEmpty) ||
              ...
              (item.addOns!.isNotEmpty && module!.addOn!)
                  ...
                  : const SizedBox(),
              SizedBox(
                  height: (item.addOns!.isNotEmpty && module!.addOn!)
                      ? Dimensions.paddingSizeSmall
                      : 0),
