        ...
        return GetBuilder<PaymentController>(builder: (bankController) {
          return (profileController.profileModel != null &&
              ...
              ? (profileController.modulePermission!.wallet! ||
                      profileController.modulePermission!.myWallet!)
                  ? RefreshIndicator(
                      onRefresh: () async {
                                ...
                                children: [
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: !paymentController.adjustmentLoading
                                                                                    ? Text(
                                                                                        'ok'.tr,
                                                        ...
                                                        if (Get.find<
                                                          ...
                                                          showCustomSnackBar(
                                                            ...
                                                            profileController
                                                                ...
                                                                .cashInHands!) {
                                                          showCustomSnackBar(
                                                              '${'you_do_not_have_sufficient_balance_to_pay_the_minimum_payable_balance_is'.tr} ${PriceConverterHelper.convertPrice(Get.find<SplashController>().configModel!.minAmountToPayStore)}');
                                                        }
                                                      }
                                                    },
                                                    child: Container(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(children: [
                                      InkWell(
                                        onTap: () {
                                          if (bankController.selectedIndex !=
                                              0) {
                                  ...
                                  Row(
                                      ...
                                      children: [
                                        Text("transaction_history".tr,
                                            style: robotoMedium),
                                        (bankController.selectedIndex == 0 &&
                                                    (bankController
                                                                .withdrawList !=
                                                            null &&
                                                        bankController
                                                      ...
                                                      child: Row(children: [
                                                        Expanded(
                                                          child: Column(
                                                              ...
                                                              children: [
                                                                Text(
                                                                    PriceConverterHelper.convertPrice(bankController
                                                                        .transactions![
                                                                            index]
                                                                        .amount),
                                                                    style: robotoMedium.copyWith(
