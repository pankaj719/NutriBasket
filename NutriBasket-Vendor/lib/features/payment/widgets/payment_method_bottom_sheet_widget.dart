...
class PaymentMethodBottomSheetWidget extends StatefulWidget {
  ...
  const PaymentMethodBottomSheetWidget(
      {super.key, this.isWalletPayment = false});
            ...
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  bool isSelected = paymentController.paymentIndex == 1 &&
                      Get.find<SplashController>()
                              .configModel!
                              .activePaymentMethodList![index]
                              .getWay! ==
                          paymentController.digitalPaymentName;
                  return InkWell(
                    onTap: () {
                      paymentController.setPaymentIndex(1);
                      paymentController.changeDigitalPaymentName(
                          Get.find<SplashController>()
                              .configModel!
                              .activePaymentMethodList![index]
                              .getWay!);
                  ...
                  onPressed: () {
                    if (widget.isWalletPayment) {
                      double amount = Get.find<ProfileController>()
                          .profileModel!
                          .cashInHands!;
                      Get.find<PaymentController>().makeCollectCashPayment(
                          amount,
                          Get.find<PaymentController>().digitalPaymentName!);
                    } else {
                      Get.back();
                    }
                  }),
