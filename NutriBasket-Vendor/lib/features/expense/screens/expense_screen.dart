...
import 'package:sixam_mart_store/features/expense/controllers/expense_controller.dart';
import 'package:sixam_mart_store/helper/date_converter_helper.dart';
import 'package:sixam_mart_store/util/dimensions.dart';
import 'package:sixam_mart_store/util/styles.dart';
import 'package:sixam_mart_store/common/widgets/custom_app_bar_widget.dart';
import 'package:sixam_mart_store/common/widgets/custom_snackbar_widget.dart';
import 'package:sixam_mart_store/features/expense/widgets/expense_card_widget.dart';
...
class _ExpenseScreenState extends State<ExpenseScreen> {
  ...
  void initState() {
    ...
    Get.find<ExpenseController>().getExpenseList(
      ...
      from: Get.find<ExpenseController>().from,
      to: Get.find<ExpenseController>().to,
      ...
      if (scrollController.position.pixels ==
        ...
        if (Get.find<ExpenseController>().offset < pageSize) {
          Get.find<ExpenseController>()
              .setOffset(Get.find<ExpenseController>().offset + 1);
        ...
        return Column(children: [
            ...
            child: Row(children: [
                          ...
                          onPressed: () {
                            if (!expenseController.searchMode) {
                              if (_searchController.text.isNotEmpty) {
                                expenseController.setSearchText(
                                    offset: '1',
                                    from: Get.find<ExpenseController>().from,
                                    to: Get.find<ExpenseController>().to,
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  padding:
                      const EdgeInsets.all(Dimensions.paddingSizeSmall + 1),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Container(
              ...
              child: Text(
                  DateConverterHelper.convertDateToDate(
            ...
            Container(
              ...
              child: Text(
                  DateConverterHelper.convertDateToDate(expenseController.to!),
                  style: robotoMedium),
            ),
          ]),
          Expanded(
            child: expenseController.expenses != null
                ? expenseController.expenses!.isNotEmpty
                    ? ListView.builder(
                    ...
                    : Center(
                        child: Text('no_expense_found'.tr, style: robotoMedium))
