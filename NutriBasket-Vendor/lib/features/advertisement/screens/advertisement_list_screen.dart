...
class _AdvertisementListScreenState extends State<AdvertisementListScreen> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        int pageSize =
            (Get.find<AdvertisementController>().pageSize! / 10).ceil();
        if (Get.find<AdvertisementController>().offset < pageSize) {
          Get.find<AdvertisementController>()
              .setOffset(Get.find<AdvertisementController>().offset + 1);
          Get.find<AdvertisementController>().showBottomLoader();
          Get.find<AdvertisementController>().getAdvertisementList(
            Get.find<AdvertisementController>().offset.toString(),
            Get.find<AdvertisementController>().type,
          );
        }
      }
    });
        ...
        body: Container(
          ...
          child: Column(children: [
                ...
                ? SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return statusWidget(
                          adsController: advertisementController,
                          title: advertisementController.statusList[index].tr,
                          index: index,
                          count: count,
                        );
                      },
            ...
            isTabShow
                ...
                : const SizedBox(),
            Expanded(
              child: advertisementController.advertisementList != null
                  ? advertisementController.advertisementList!.isNotEmpty
                      ? advertisementListWidget(advertisementController,
  ...
  Widget advertisementListWidget(
      AdvertisementController adsController, List<Adds>? advertisementList) {
      ...
      return Column(children: [
        ...
        Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                String status = advertisementList[index].status == 'approved' &&
                        advertisementList[index].active == 1
                    ? 'running'
                    : advertisementList[index].status == 'approved' &&
                            advertisementList[index].active == 0
                        ? 'expired'
                        : advertisementList[index].status!;
                return InkWell(
                  onTap: () {
                    Get.toNamed(RouteHelper.getAdvertisementDetailsScreen(
                        advertisementId: advertisementList[index].id));
                  },
                  child: Container(
                            ...
                            Column(
                                ...
                                children: [
                                  Row(children: [
                                    ...
                                    Text(' # ${advertisementList[index].id}',
                                        style: robotoBold),
                                      ...
                                      if (option.title == "edit_ads") {
                                        ...
                                        adsController
                                            .getAdvertisementDetails(
                                                id: advertisementList[index]
                                                    .id!)
                                            .then((AdsDetailsModel?
                                                adsDetailsModel) {
                                          Get.back();
                                        ...
                                        status == 'running'
                                            ? showCustomBottomSheet(
                                                ...
                                                image: Images.cautionDialogIcon,
                                                title:
                                                    "can't_delete_dialog_title",
                                                description:
                                                    "can't_delete_dialog_description",
                                                status: option.title,
                                            ...
                                            : showCustomBottomSheet(
                                                child: ConfirmationBottomSheet(
                                                image: Images.deleteDialogIcon,
                                                title:
                                                    "confirm_delete_dialog_title",
                                                description:
                                                    "confirm_delete_dialog_description",
                                                status: option.title,
                                                yesButtonPressed: () async {
                                                  adsController
                                                      .deleteAdvertisement(
                                                    ...
                                                    if (success) {
                                                      Get.back();
                                                      showCustomSnackBar(
                                                          'advertisement_deleted_successfully'
                                                              .tr,
                                                          isError: false);
                                                    }
                                                  });
                                                ...
                                                if (adsController
                                                  ...
                                                  await Get.find<
                                                    ...
                                                    if (success) {
                                                      Get.back();
                                                      showCustomSnackBar(
                                                          'advertisement_paused_successfully'
                                                              .tr,
                                                          isError: false);
                                                    }
                                                  });
                                        ...
                                        showCustomBottomSheet(
                                          child: ConfirmationBottomSheet(
                                            image: Images.resumeDialogIcon,
                                            title: "resume_dialog_title",
                                            description:
                                                "resume_dialog_description",
                                            status: option.title,
                                            yesTestColor:
                                            ...
                                            yesButtonPressed: () async {
                                              await adsController
                                                ...
                                                if (success) {
                                                  Get.back();
                                                  showCustomSnackBar(
                                                      'advertisement_resume_successfully'
                                                          .tr,
                                                      isError: false);
                                                }
                                              });
  ...
  Widget statusWidget(
      {required AdvertisementController adsController,
    ...
    return InkWell(
      onTap: () {
        ...
        adsController.getAdvertisementList(
            adsController.offset.toString(), adsController.type);
      },
      child: Row(children: [
        Container(
          padding: const EdgeInsets.symmetric(
