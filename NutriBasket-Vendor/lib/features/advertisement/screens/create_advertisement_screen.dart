...
class CreateAdvertisementScreen extends StatefulWidget {
  ...
  const CreateAdvertisementScreen(
      {super.key, this.adsDetailsModel, this.fromCopy = false});
...
class _CreateAdvertisementScreenState extends State<CreateAdvertisementScreen>
  ...
  void _editSetup() {
    ...
    validationController?.text =
        "${DateConverterHelper.stringToMDY(widget.adsDetailsModel?.startDate ?? "")} - ${DateConverterHelper.stringToMDY(widget.adsDetailsModel?.endDate ?? "")}";

    for (int index = 1; index < _languageList!.length; index++) {
      widget.adsDetailsModel?.translations?.forEach((element) {
        if (element.locale == _languageList[index].key &&
            element.key == "title") {
          titleController[index].text = element.value ?? "";
        } else if (element.locale == _languageList[index].key &&
    ...
    Get.find<AdvertisementController>()
        .initializeAdvertisementValues(widget.adsDetailsModel!);
    Get.find<AdvertisementController>().dateTimeRange = DateTimeRange(
      start: DateConverterHelper.isoUtcStringToLocalDateOnly(
          widget.adsDetailsModel?.startDate ?? ""),
      end: DateConverterHelper.isoUtcStringToLocalDateOnly(
          widget.adsDetailsModel?.endDate ?? ""),
    );
  }

  void _getPromotionList() {
    for (int i = 0;
        i < Get.find<AdvertisementController>().adsTypes.length;
        i++) {
      promotionList.add(DropdownItem<int>(
          value: i,
          child: SizedBox(
            child: Padding(
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AdvertisementController>(builder: (adsController) {
      return Scaffold(
        appBar: CustomAppBarWidget(
            title: widget.adsDetailsModel != null
                ? widget.fromCopy!
                    ? 'new_advertisement'.tr
                    : 'update_advertisement'.tr
                : 'new_advertisement'.tr),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                  ...
                  children: [
                        ...
                        child: Column(children: [
                          ...
                          Container(
                            ...
                            child: CustomDropdown<int>(
                              onChange: (int? value, int index) {
                                adsController.setAdsType(
                                    type: adsController.adsTypes[index]);
                              },
                          ...
                          InkWell(
                            ...
                            child: CustomTextFieldWidget(
                              ...
                              isEnabled: false,
                              hideEnableText: true,
                              suffixChild: Icon(Icons.date_range_rounded,
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  ...
                                  if (widget.adsDetailsModel != null) {
                                    bool isNotValidTimeRange =
                                        adsController.validateTimeRange(
                          ...
                          Column(children: [
                            ...
                            CustomTextFieldWidget(
                              ...
                              focusNode: _titleFocus[
                                  multiLanguageTabController!.index],
                              nextFocus: multiLanguageTabController!.index !=
                            ...
                            CustomTextFieldWidget(
                              ...
                              focusNode: _descriptionFocus[
                                  multiLanguageTabController!.index],
                              inputAction: multiLanguageTabController!.index !=
                                      _languageList.length - 1
                    ...
                    adsController.selectedAdsType ==
                            AdsType.store_promotion.name
                        ? const SizedBox(height: Dimensions.paddingSizeLarge)
                        : const SizedBox(),
                    adsController.selectedAdsType ==
                            AdsType.store_promotion.name
                            ...
                            child: Row(
                                ...
                                children: [
                                  CustomCheckBox(
                                    ...
                                    title: 'review'.tr,
                                    onTap: () =>
                                        adsController.toggleReviewChecked(),
                                  ),
                                  ...
                                  CustomCheckBox(
                                    ...
                                    title: 'rating'.tr,
                                    onTap: () =>
                                        adsController.toggleRatingChecked(),
                                  ),
                                ]),
                          )
                        : const SizedBox(),
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        adsController.selectedAdsType ==
                                AdsType.video_promotion.name
                            ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                    adsController.pickedVideoFile == null &&
                                            adsController.networkVideoFile ==
                                                null
                                        ? AspectRatio(
                                            aspectRatio: 16 / 8,
                                            child: DottedVideoBorder(
                                              showErrorBorder:
                                                  !adsController.isVideoValid,
                                              text: 'click_to_upload_ads_video'
                                                  .tr,
                                              onTap: () => adsController
                                                  .pickVideoFile(false),
                                            ),
                                          )
                                        : adsController.videoPlayerController!
                                                .value.isInitialized
                                            ? Stack(
                                                alignment: Alignment.center,
                                                children: [
                                                  AspectRatio(
                                                    aspectRatio: adsController
                                ...
                                children: [
                                    Center(
                                      child: Stack(children: [
                                        ...
                                        adsController.pickedProfileImage !=
                                                    null ||
                                                adsController
                                                        .networkProfileImage !=
                                                    null
                                    ...
                                    !adsController.isProfileImageValid
                                        ? Center(
                                            child: Padding(
                                              padding: const EdgeInsets.only(
                                                  top: Dimensions
                                    ...
                                    AspectRatio(
                                      ...
                                      child: Stack(children: [
                                        ...
                                        adsController.pickedCoverImage !=
                                                    null ||
                                                adsController
                                                        .networkCoverImage !=
                                                    null
                                    ...
                                    !adsController.isCoverImageValid
                                        ? Padding(
                                            padding: const EdgeInsets.only(
                                                top: Dimensions
                                                    .paddingSizeExtraSmall),
                                            child: Text(
                                              "enter_cover_image".tr,
                                              overflow: TextOverflow.ellipsis,
                                              style: robotoRegular.copyWith(
                                                  color: Theme.of(context)
                                                      .colorScheme
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: CustomButtonWidget(
                    buttonText:
                        widget.adsDetailsModel != null && !widget.fromCopy!
                            ? 'update_ads'.tr
                            : 'create_ads'.tr,
                    ...
                    onPressed: () {
                      ...
                      if (widget.adsDetailsModel != null) {
                        if (adsController.selectedAdsType ==
                            AdsType.video_promotion.name) {
                          if (formKey.currentState!.validate() &&
                              adsController.isVideoValid) {
                            if (widget.fromCopy!) {
                              adsController.copyAddAdvertisement(
                                  adsId: widget.adsDetailsModel!.id!,
                                  titleController: titleController,
                                  descriptionController: descriptionController,
                                  languageList: _languageList);
                            } else {
                              adsController.editAdvertisement(
                                  widget.adsDetailsModel!,
                        ...
                        if (adsController.selectedAdsType ==
                          ...
                          if (formKey.currentState!.validate() &&
                              adsController.isVideoValid) {
                            adsController.submitNewAdvertisement(
                                titleController: titleController,
                                descriptionController: descriptionController,
                                languageList: _languageList);
                          }
        ...
        floatingActionButton: Padding(
          ...
          child: FloatingActionButton(
            ...
            child: Stack(
              ...
              children: [
                const CustomAssetImageWidget(Images.previewImage,
            ...
            onPressed: () {
              if (adsController.pickedVideoFile != null &&
                  adsController.videoPlayerController!.value.isInitialized) {
                adsController.videoPlayerController!.pause();
              }

              Get.dialog(
                  adsController.selectedAdsType == AdsType.video_promotion.name
                      ? PreviewVideoDialogWidget(
                      ...
                      : PreviewProviderPromotionWidget(
                          ...
                          pickedCoverImage:
                              adsController.pickedCoverImage?.path,
                          networkCoverImage: adsController.networkCoverImage,
                          pickedProfileImage:
                              adsController.pickedProfileImage?.path,
                          networkProfileImage:
                              adsController.networkProfileImage,
  ...
  String modifyDateRange(DateTimeRange? dateTimeRange) {
    String firstDate =
        DateConverterHelper.stringToMDY(dateTimeRange?.start.toString() ?? "");
    String lastDate =
        DateConverterHelper.stringToMDY(dateTimeRange?.end.toString() ?? "");
