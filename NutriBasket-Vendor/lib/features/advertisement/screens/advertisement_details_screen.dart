      ...
      return PopScope(
        ...
        child: Scaffold(
          ...
          body: Column(children: [
            Expanded(
              child: advertisementController.advertisementDetailsModel == null
                  ? const Center(child: CircularProgressIndicator())
                  : GetBuilder<AdvertisementController>(
                      builder: (advertisementController) {
                      String? status = advertisementController
                                      .advertisementDetailsModel!.status ==
                                  'approved' &&
                              advertisementController
                                      .advertisementDetailsModel!.active ==
                                  1
                          ? 'running'
                          : advertisementController
                                          .advertisementDetailsModel!.status ==
                              ...
                              children: [
                                Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          '${'ads_id'.tr} #${advertisementController.advertisementDetailsModel?.id}',
                                ...
                                AdsCard(
                                  ...
                                  subTitle: DateConverterHelper
                                      .dateMonthYearTime(DateConverterHelper
                                ...
                                AdsCard(
                                  ...
                                  title: 'duration'.tr,
                                  subTitle:
                                      '${DateConverterHelper.stringToLocalDateOnly(advertisementController.advertisementDetailsModel?.startDate ?? "")} - ${DateConverterHelper.stringToLocalDateOnly(advertisementController.advertisementDetailsModel?.endDate ?? "")}',
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                ),
                                const SizedBox(
                                ...
                                AdsCard(
                                  ...
                                  title: 'ads_type'.tr,
                                  subTitle:
                                      "${advertisementController.advertisementDetailsModel?.addType?.tr}"
                                          .toTitleCase()
                                          .replaceAll('_', ' '),
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                ...
                                AdsCard(
                                  ...
                                  subTitle: advertisementController
                                              .advertisementDetailsModel
                                              ?.isPaid ==
                                          1
                                      ? "paid".tr
                          ...
                          Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${advertisementController.advertisementDetailsModel?.title}",
                                    style: robotoRegular.copyWith(
                                  ...
                                  const SizedBox(
                                      height: Dimensions.paddingSizeExtraSmall),
                                  Text(
                                    "${advertisementController.advertisementDetailsModel?.description}",
                                    style: robotoRegular.copyWith(
                                        color: Theme.of(context).hintColor),
                                    textAlign: TextAlign.justify,
                                    maxLines: 100,
                                          ...
                                          children: [
                                              ...
                                              const SizedBox(
                                                  height: Dimensions
                                                      .paddingSizeExtraSmall),
                                              Text(
                                                "${advertisementController.advertisementDetailsModel?.cancellationNote}",
                                                style: robotoRegular.copyWith(
                                                    color: Theme.of(context)
                                                        .hintColor),
                                                textAlign: TextAlign.justify,
                                          ...
                                          children: [
                                              ...
                                              const SizedBox(
                                                  height: Dimensions
                                                      .paddingSizeExtraSmall),
                                              Text(
                                                "${advertisementController.advertisementDetailsModel?.pauseNote}",
                                                style: robotoRegular.copyWith(
                                                    color: Theme.of(context)
                                                        .hintColor),
                                                textAlign: TextAlign.justify,
                                  ...
                                  advertisementController
                                              ...
                                              ?.addType ==
                                          AdsType.video_promotion.name
                                      ? NetworkVideoPreviewWidget(
                                          videoFile: advertisementController
                                                  .advertisementDetailsModel
                                                  ?.videoAttachmentFullUrl ??
                                              "",
                                        )
                                      : AspectRatio(
                                          aspectRatio: 20 / 9,
                                                      ...
                                                      child: ClipRRect(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          child: CustomImageWidget(
                                                              image:
                                                                  "${advertisementController.advertisementDetailsModel?.profileImageFullUrl}",
                                                              fit:
                                                                  BoxFit.cover),
                                                        ),
                                                      ),
                                                          ...
                                                          child: ClipRRect(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                child:
                                                                    CustomImageWidget(
                                                                  image:
                                                                      "${advertisementController.advertisementDetailsModel?.coverImageFullUrl}",
                                                                  fit: BoxFit
                                                                      .cover,
                                                                ),
                                                              )),
                            ...
                            child: CustomButtonWidget(
                              ...
                              onPressed: () {
                                Get.to(() => CreateAdvertisementScreen(
                                    adsDetailsModel: advertisementController
                                        .advertisementDetailsModel));
                              },
                            ),
                          ),
                                  ...
                                  child: CustomButtonWidget(
                                    ...
                                    onPressed: () {
                                      showCustomBottomSheet(
                                        ...
                                        status: advertisementController
                                            .advertisementDetailsModel!.status!,
