            ...
            child: Stack(
              ...
              children: [
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: pickedCoverImage != null &&
                                pickedCoverImage!.isNotEmpty
                            ? Image.file(File(pickedCoverImage!),
                                fit: BoxFit.cover)
                            : networkCoverImage != null &&
                                    networkCoverImage!.isNotEmpty
                                ? CustomImageWidget(
                ...
                Positioned(
                  ...
                  child: (isShowRatings != null && isShowRatings!) ||
                          ...
                          child: Row(children: [
                            isShowRatings != null && isShowRatings!
                                ? Row(children: [
                                    ...
                                    Text(
                                        '${Get.find<ProfileController>().profileModel!.stores![0].avgRating ?? 0.0}',
                                        style: robotoMedium.copyWith(
                                            color: Theme.of(context).cardColor))
                                  ])
                                : const SizedBox(),
                      ...
                      child: Row(children: [
                        SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: networkProfileImage != null &&
                                ...
                                : pickedProfileImage != null &&
                                        pickedProfileImage!.isNotEmpty
                                    ? Image.file(File(pickedProfileImage!),
                                        fit: BoxFit.cover)
                                    : Container(
