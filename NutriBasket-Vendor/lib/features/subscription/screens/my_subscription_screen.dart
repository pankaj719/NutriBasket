...
class _MySubscriptionScreenState extends State<MySubscriptionScreen>
  ...
  void initState() {
    ...
    if (Get.find<AuthController>().isLoggedIn()) {
      ...
      Get.find<SubscriptionController>()
          .getProfile(Get.find<AuthController>().profileModel);
    }
  ...
  Future<void> _loadTrialWidgetShow() async {
    await Get.find<ProfileController>()
        .trialWidgetShow(route: RouteHelper.mySubscription);
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SubscriptionController>(
      ...
      bool businessIsCommission =
          subscriptionController.profileModel!.stores![0].storeBusinessModel ==
              'commission';
      bool businessIsNone =
          subscriptionController.profileModel!.stores![0].storeBusinessModel ==
              'none';
      ...
      return PopScope(
        ...
        child: Scaffold(
          ...
          body: subscriptionController.profileModel != null
              ? (businessIsCommission &&
                      !subscriptionController
                          .profileModel!.subscriptionTransactions!)
                  ? Column(children: [
                      Expanded(
                        child: Padding(
                          padding:
                          ...
                          child: Container(
                            ...
                            child: Column(children: [
                              ...
                              Text(
                                '${Get.find<ProfileController>().profileModel != null && Get.find<ProfileController>().profileModel!.stores?[0].comission != null && Get.find<ProfileController>().profileModel!.stores![0].comission! > 0 ? Get.find<ProfileController>().profileModel!.stores![0].comission! : Get.find<SplashController>().configModel?.adminCommission} %',
                                style: robotoBold.copyWith(
                      ...
                      ? Column(children: [
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          "chose_a_business_plan_from_the_list_so_that_you_get_more_options_to_join_the_business_for_the_growth_and_success"
                                              .tr,
                                          style: robotoRegular.copyWith(
                                              fontSize:
                          ...
                          Container(
                            padding: const EdgeInsets.all(
                                Dimensions.paddingSizeDefault),
                            child: CustomButtonWidget(
                              buttonText: (businessIsNone ||
                                      (businessIsUnsubscribed &&
                                          (subscriptionController
                                                  .profileModel?.subscription ==
                                              null)))
                                  ? 'chose_business_plan'.tr
