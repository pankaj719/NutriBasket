                            ...
                            Row(children: [
                              ...
                              Expanded(
                                ...
                                child: Wrap(
                                    ...
                                    children: [
                                      Text(
                                          '${PriceConverterHelper.convertPrice(widget.subscriptionController.profileModel!.subscription!.package!.price)} /',
                                          style: robotoBold.copyWith(
                                              fontSize: 22)),
                                      Text(
                                          ' ${widget.subscriptionController.profileModel!.subscription!.package!.validity} ${'days'.tr}',
                                          style: robotoMedium),
                                    ]),
                              ),
                            ]),
                            ...
                            PackageFeatureItem(
                              title: widget.subscriptionController.profileModel!
                                  ...
                                  ? isRental
                                      ? 'max_trip'.tr
                                      : 'max_order'.tr
                                  : '${widget.subscriptionController.profileModel!.subscription?.package?.maxOrder} ${isRental ? 'trip'.tr : 'order'.tr}',
                              leftValue: widget
                                          .subscriptionController
                                          .profileModel!
                                          .subscription!
                            ...
                            PackageFeatureItem(
                              title: widget.subscriptionController.profileModel!
                                  ...
                                  ? isRental
                                      ? 'max_vehicle'.tr
                                      : 'max_product'.tr
                                  : '${widget.subscriptionController.profileModel!.subscription?.package?.maxProduct} ${isRental ? 'vehicle_upload'.tr : 'products_upload'.tr}',
                              leftValue: widget
                                          .subscriptionController
                                          .profileModel!
                                          .subscription!
