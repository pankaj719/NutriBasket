...
class ChangeSubscriptionPlanBottomSheet extends StatefulWidget {
  ...
  const ChangeSubscriptionPlanBottomSheet(
      {super.key, required this.businessIsCommission});
        ...
        for (var element in subscriptionController.packageList!) {
          if (subscriptionController.profileModel!.subscription != null) {
            if (subscriptionController
                    .profileModel!.subscription!.package!.id ==
                element.id) {
              activePackageIndex =
                  subscriptionController.packageList!.indexOf(element);
              if (kDebugMode) {
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text(
                  (businessIsNone ||
                      ...
                      : 'renew_or_shift_your_plan_to_get_better_experience'.tr,
                ...
                SizedBox(
                  height: 470,
                  child: subscriptionController.packageList!.isNotEmpty
                      ? Swiper(
                          ...
                          onIndexChanged: (index) {
                            ...
                            subscriptionController
                                .activePackage(activePackageIndex == index);
                          },
                          itemBuilder: (context, index) {
                            Packages package =
                                subscriptionController.packageList![index];
                            bool isCommission = package.id == -1;

                            return Stack(children: [
                              PackageCardWidget(
                                currentIndex: subscriptionController
                                ...
                                child: Padding(
                                  ...
                                  child: !subscriptionController.isLoading
                                      ? CustomButtonWidget(
                                          ...
                                          buttonText: (subscriptionController
                                                          .isActivePackage !=
                                                      null &&
                                                  subscriptionController
                                                      .isActivePackage! &&
                                          ...
                                          onPressed: (isCommission &&
                                                  widget.businessIsCommission)
                                              ? null
                                              : () {
                                                  if (((subscriptionController
                                                                  .isActivePackage! &&
                                                    ...
                                                    showCustomBottomSheet(
                                                      child:
                                                          RenewSubscriptionPlanBottomSheet(
                                                        isRenew: true,
                                                        package: package,
                                                        checkProductLimitModel:
                                                            null,
                                                        nonSubscription: businessIsNone ||
                                                            (businessIsUnsubscribed &&
                                                                (subscriptionController
                                                                        .profileModel
                                                                        ?.subscription ==
                                                    ...
                                                    subscriptionController
                                                      ...
                                                      activePackage: subscriptionController
                                                              .packageList![
                                                          businessIsCommission
                                                              ? subscriptionController
                                                                  .activeSubscriptionIndex
