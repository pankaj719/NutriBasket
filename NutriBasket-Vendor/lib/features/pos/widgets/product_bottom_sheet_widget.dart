  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: GetBuilder<PosController>(builder: (posController) {
        ...
        double? discount = (isCampaign || item!.storeDiscount == 0)
            ? item!.discount
            : item!.storeDiscount;
        String? discountType = (isCampaign || item!.storeDiscount == 0)
            ? item!.discountType
            : 'percent';
        ...
        CartModel cartModel = CartModel(
          ...
          discountAmount: (price! -
              PriceConverterHelper.convertWithDiscount(
                  price, discount, discountType)!),
          item: item,
          quantity: posController.quantity,
                      ...
                      children: [
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        '${endingPrice != null ? ' - ${PriceConverterHelper.convertPrice(endingPrice, discount: discount, discountType: discountType)}' : ''}',
                                        style: robotoMedium.copyWith(
                                            fontSize: Dimensions.fontSizeLarge),
                                      ),
                                      const SizedBox(height: 5),
                                ...
                                children: [
                                  ...
                                  GridView.builder(
                                    ...
                                    itemBuilder: (context, i) {
                                      return InkWell(
                                        onTap: () {
                                          posController.setCartVariationIndex(
                                              index, i);
                                        },
                                        child: Container(
                        ...
                        Row(children: [
                          ...
                          Row(children: [
                            ...
                            Text(posController.quantity.toString(),
                                style: robotoMedium.copyWith(
                                    fontSize: Dimensions.fontSizeLarge)),
                            QuantityButtonWidget(
                              onTap: () =>
                                  posController.setProductQuantity(true),
                              isIncrement: true,
                            ),
                          ]),
                        ]),
