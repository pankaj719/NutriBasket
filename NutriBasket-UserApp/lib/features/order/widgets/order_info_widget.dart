...
import 'package:sixam_mart/features/order/widgets/bulk_edit_quantity_dialog.dart';
import 'package:sixam_mart/features/order/widgets/b2b_edit_quantity_dialog.dart';
          ...
          Container(
            ...
            child: Column(
                ...
                children: [
                    ...
                    child: Row(children: [
                      ...
                      Text(
                        order.orderStatus == 'delivered' &&
                            ...
                            : order.orderStatus == 'delivered' &&
                                    order.acknowledgedAt != null
                                ? '${'order_acknowledged'.tr} \n${DateConverter.dateTimeStringToDateTime(order.acknowledgedAt!)}'
                  ...
                  // Add countdown timer for delivered orders that are editable (but not acknowledged)
                  if (orderController.isOrderEditableAfterDelivery(order) &&
                      order.acknowledgedAt == null)
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              '${'order_editable_until_acknowledged'.tr}. ${'order_will_be_acknowledged_in'.tr} ${orderController.getTimeRemainingForAcknowledgment(order)}',
                              style: robotoRegular.copyWith(
                                fontSize: Dimensions.fontSizeExtraSmall,
                                color: Colors.orange,
                              ),
                              ...
                              children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      // Show edit button for pending/confirmed orders OR delivered B2B orders within 24h (but not acknowledged)
                                      if ((ongoing &&
                                        ...
                                        TextButton.icon(
                                          onPressed: () {
                                            if (orderController
                                                .isOrderEditableAfterDelivery(
                                                    order)) {
                                              // Use B2B dialog for delivered orders
                                              Get.dialog(
                                                B2bEditQuantityDialog(
                                              ...
                                              // Use regular dialog for ongoing orders
                                              Get.dialog(
                                                BulkEditQuantityDialog(
                                                  orderDetails: orderController
                                                      .orderDetails!,
                                                  orderId: order.id.toString(),
                                                ),
                                          ...
                                          onTap: () async {
                                            ...
                                            await Get.toNamed(
                                              ...
                                              user: User(
                                                  ...
                                                  fName:
                                                      order.deliveryMan!.fName,
                                                  lName:
                                                      order.deliveryMan!.lName,
                                                  imageFullUrl: order
                                                      .deliveryMan!
                                                      .imageFullUrl),
                                            ));
