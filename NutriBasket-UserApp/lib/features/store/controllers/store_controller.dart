...
class StoreController extends GetxController implements GetxService {
  ...
  bool isStoreClosed(bool today, bool active, List<Schedules>? schedules) {
    // Always return false to allow ordering regardless of store hours
    return false;

    // Original store hours validation logic disabled:
    // if (!active) {
    //   return true;
    // }
  ...
  bool isStoreOpenNow(bool active, List<Schedules>? schedules) {
    // Always return true to allow ordering regardless of store hours
    return true;
