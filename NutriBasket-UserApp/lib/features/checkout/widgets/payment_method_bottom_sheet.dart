...
class PaymentMethodBottomSheet extends StatefulWidget {
  ...
  final bool hideDigitalPayment; // <-- Add this line
  const PaymentMethodBottomSheet(
      ...
      this.hideDigitalPayment = false}); // <-- Add this line
...
class _PaymentMethodBottomSheetState extends State<PaymentMethodBottomSheet> {
  ...
  bool notHideWallet = false;
  bool notHideDigital = false;
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      widget.storeId == null &&
                              ...
                              notHideDigital &&
                              !widget
                                  .hideDigitalPayment // <-- Add this condition
                          ? Row(children: [
