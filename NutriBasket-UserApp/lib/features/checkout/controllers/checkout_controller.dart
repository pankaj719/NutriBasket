  ...
  void callback(
    ...
    if (isSuccess) {
      ...
      if (paymentMethodIndex == 2 &&
          digitalPaymentName?.toLowerCase() == 'offline_payment') {
        // Show offline payment instructions
        // You must pass the correct PlaceOrderBodyModel and other required named params here if needed
        // Example (uncomment and fix as needed):
        ...
        //   forParcel: false,
        // ));
        // For now, fallback to order success screen for offline_payment as well:
        Get.offAllNamed(RouteHelper.getOrderSuccessRoute(
          ...
          digitalPaymentName?.toLowerCase() != 'postpaid' &&
          digitalPaymentName?.toLowerCase() != 'wallet' &&
          digitalPaymentName?.toLowerCase() != 'cash_on_delivery') {
        // Digital payment: open payment page
        ...
        // postpaid, cash_on_delivery, wallet: show order confirmation
          ...
          Future.delayed(
              ...
              () => Get.dialog(Center(
                  child: SizedBox(
                      height: 350,
                      width: 500,
                      child: OrderSuccessfulDialog(
                        orderID: orderID,
                        contactPersonNumber: contactNumber,
                        createAccount: _isCreateAccount,
                        guestId: userID.isNotEmpty
                            ? userID
