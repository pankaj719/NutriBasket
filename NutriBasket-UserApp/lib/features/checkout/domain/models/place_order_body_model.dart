...
class PlaceOrderBodyModel {
  ...
  PlaceOrderBodyModel.fromJson(Map<String, dynamic> json) {
    ...
    _deliveryCharge = json['delivery_charge'] != null
...
class OnlineCart {
  ...
  List<int?>? _addOnIds;
  List<AddOns>? _addOns;
  List<double>? _addOnQtys;
  String? _model;
  String? _itemType;
  // B2B Contract Pricing Fields
  bool? _isB2BUser;
  String? _userType;
  Map<String, dynamic>? _b2bContractPricing;
  ...
  OnlineCart(
    ...
    _model = model;
    _itemType = itemType;
    // Initialize B2B pricing fields
    _isB2BUser = B2BPricingHelper.isB2BUser();
    _userType = B2BPricingHelper.getUserType();
    _b2bContractPricing = B2BPricingHelper.isB2BUser()
        ? Get.find<ProfileController>().userInfoModel?.b2bContractPricing
        : null;
  }
  ...
  List<double>? get addOnQtys => _addOnQtys;
  ...
  OnlineCart.fromJson(Map<String, dynamic> json) {
    ...
    _addOnQtys = json['add_on_qtys'] != null
        ? (json['add_on_qtys'] as List)
  ...
  Map<String, dynamic> toJson() {
    ...
    // Include B2B pricing information
    if (_isB2BUser != null) {
      data['is_b2b_user'] = _isB2BUser;
    }
    if (_userType != null) {
      data['user_type'] = _userType;
    }
    if (_b2bContractPricing != null) {
      data['b2b_contract_pricing'] = _b2bContractPricing;
    }
    return data;
  }
}
