...
class _DetailsWebViewWidgetState extends State<DetailsWebViewWidget> {
  ...
  void _updateQuantityController() {
    ...
    final currentQuantity = itemController.cartIndex != -1
        ? cartController.cartList[itemController.cartIndex].quantity
        : itemController.quantity;
    
    final currentText = currentQuantity?.toString() ?? '';
    
    // Only update if the controller text is different to avoid cursor jumping
    if (_quantityController.text != currentText) {
      _quantityController.text = currentText;
    }
    if (_quantityController2.text != currentText) {
      _quantityController2.text = currentText;
    }
  }
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(children: [
                                        GetBuilder<CartController>(
                                            builder: (cartController) {
                                          // Update controller with current quantity if needed
                                                ...
                                                onChanged: (value) {
                                                  ...
                                                  if (parsed != null && parsed >= 0) {
                                                    ...
                                                    if (itemController.cartIndex != -1) {
                                                      cartController.setManualQuantity(
                                                        finalValue,
                                                        itemController.cartIndex
                                                      );
                                                    } else {
                                                      itemController.setManualQuantity(finalValue);
                                                    }
                                                  }
                                                },
                                              ),
