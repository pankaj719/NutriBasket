...
class CartRepository implements CartRepositoryInterface<OnlineCartModel> {
  ...
  @override
  Future add(OnlineCartModel cart) async {
    return await _addToCartOnline(cart);
  }

  Future<List<OnlineCartModel>?> _addToCartOnline(OnlineCartModel cart) async {
  ...
  Future update(Map<String, dynamic> body, int? id,
      {double? price, double? quantity, bool isUpdateQty = false}) async {
    if (isUpdateQty) {
