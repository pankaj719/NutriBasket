...
class UserInfoModel {
  ...
  String? userType;
  bool? isB2BUser;
  Map<String, dynamic>? b2bContractPricing;
  ...
  UserInfoModel.fromJson(Map<String, dynamic> json) {
    ...
    isB2BUser = json['is_b2b_user'] == 1;
    
    // Debug logging for B2B contract pricing
    if (kDebugMode) {
      print('UserInfoModel.fromJson Debug:');
      print('  user_type: ${json['user_type']}');
      print('  is_b2b_user: ${json['is_b2b_user']}');
      print('  b2b_contract_pricing exists: ${json.containsKey('b2b_contract_pricing')}');
      print('  b2b_contract_pricing value: ${json['b2b_contract_pricing']}');
      // Check for alternative field names
      print('  All JSON keys: ${json.keys.toList()}');
    }
    
    b2bContractPricing = json['b2b_contract_pricing'] != null
        ? Map<String, dynamic>.from(json['b2b_contract_pricing'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_b2b_user'] = isB2BUser;
    data['b2b_contract_pricing'] = b2bContractPricing;
    return data;
  }
}
