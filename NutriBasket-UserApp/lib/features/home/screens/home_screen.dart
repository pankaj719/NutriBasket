...
// Import your grocery home screen widgets
...
import 'package:sixam_mart/features/home/widgets/views/latest_products_view.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload, {bool fromModule = false}) async {
    ...
    if (AuthHelper.isLoggedIn()) {
      ...
      // Load user templates
      Get.find<FavouriteController>().getTemplateList();
    }
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    // Force grocery module setup
    final splashController = Get.find<SplashController>();
    if (splashController.module == null) {
      splashController.switchModule(0, true); // assuming 0 is grocery
    }
    ...
    // Check for repeat order suggestions when home screen loads
  }

  // Separate method to handle data loading with proper state management
  Future<void> _loadAllData() async {
    ...
    try {
      await HomeScreen.loadData(false).then((value) {
          ...
          body: SafeArea(
            child: RefreshIndicator(
              onRefresh: () async {
                ...
                await _refreshData(); // Use separate refresh method
                  ...
                  : _isLoading
                      ...
                      : CustomScrollView(
                          ...
                          slivers: [
                            ...
                            /// Grocery Home Screen Content with GetBuilder wrappers
                            SliverToBoxAdapter(
                              child: Center(
                                  child: SizedBox(
                                width: Dimensions.webMaxWidth,
  ...
  Future<void> _refreshData() async {
    ...
    if (AuthHelper.isLoggedIn()) {
      ...
      // Load user templates on refresh
      Get.find<FavouriteController>().getTemplateList();
    }
  }
}
