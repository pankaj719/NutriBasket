...
class SplashController extends GetxController implements GetxService {
  ...
  Module getModuleConfig(String? moduleType) {
    // Handle null or invalid module type
    if (moduleType == null ||
        moduleType.isEmpty ||
        !_data!['module_config'].containsKey(moduleType)) {
      // Default to food module if module type is invalid
      moduleType = 'food';
      print('Using default module type: food');
    }
