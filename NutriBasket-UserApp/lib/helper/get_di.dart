...
Future<Map<String, Map<String, String>>> init() async {
  ...
  TaxiHomeRepositoryInterface taxiHomeRepositoryInterface =
  ...
  Get.lazyPut(() => CartController(
      cartServiceInterface: Get.find(), cartRepositoryInterface: Get.find()));
