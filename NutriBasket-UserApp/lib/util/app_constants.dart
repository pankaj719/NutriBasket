...
class AppConstants {
  static const String appName = 'NutriBasket';
  ...
  static const String newArrivalItemsUri = '/api/v1/items/new-arrival';
  ...
  /// Template Wishlist
  static const String templateListUri = '/api/v1/customer/templates';
  static const String createTemplateUri = '/api/v1/customer/templates';
  static const String updateTemplateUri = '/api/v1/customer/templates/';
  static const String deleteTemplateUri = '/api/v1/customer/templates/';
  static const String convertOrderToTemplateUri =
      '/api/v1/customer/templates/convert-from-order';
  ...
  static const String orderChangeRequestUri = '/api/v1/order-change-requests';
  static const String orderChangeRequestBulkUri =
      '/api/v1/order-change-requests';

  /// B2B Order Management
  static const String b2bEditableOrderUri =
      '/api/v1/customer/order/b2b/editable';
  static const String b2bSubmitChangesUri =
      '/api/v1/customer/order/b2b/submit-changes';
  static const String b2bChangeRequestsUri =
      '/api/v1/customer/order/b2b/change-requests';
