    ...
    return Container(
      ...
      child: GetBuilder<ItemController>(builder: (itemController) {
        ...
        if (widget.item!.choiceOptions!.isNotEmpty &&
          ...
          startingPrice = itemController.getStartingPrice(widget.item!);
        }

        double? price = itemController.getStartingPrice(widget.item!);
                          ...
                          SafeArea(
                            child: Row(children: [
                              ...
                              Row(children: [
                                QuantityButton(
                                  onTap: () {
                                    if (itemController.quantity! > 0.1) {
                                ...
                                Text(
                                    itemController.quantity!.toStringAsFixed(1),
                                    style: robotoMedium.copyWith(
                                ...
                                return CustomButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (invalid != null) {
                                        ...
                                        // Get the cart ID when updating existing item
                                        int? cartId;
                                        if (widget.cart != null) {
                                          cartId = widget.cart!.id;
                                        } else if (itemController.cartIndex !=
                                            -1) {
                                        ...
                                        if (widget.isCampaign) {
                                          ...
                                          // Check if this would add a different store's item
                                          bool hasDifferentStore = false;
