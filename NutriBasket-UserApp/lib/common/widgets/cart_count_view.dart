...
class CartCountView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CartController>(builder: (cartController) {
      double cartQty =
          cartController.cartQuantity(item.id!, cartController.cartList);
      String cartVariant =
          cartController.cartVariant(item.id!, cartController.cartList);
      int cartIndex = cartController.isExistInCart(
          cartController.cartList, item.id, cartVariant, false, null);
      return cartQty != 0
          ? Center(
              child: Container(
                width: 100,
