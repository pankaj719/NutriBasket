...
Route::post('admin/order/update-item-stock', [OrderController::class, 'updateItemStock'])->name('admin.order.update-item-stock');
...
Route::get('admin/b2b-users', [B2BUserController::class, 'index'])->name('admin.users.b2b.index');
Route::put('admin/users/b2b-packagers/{id}', [\App\Http\Controllers\Admin\B2BPackagerController::class, 'update'])->name('admin.users.b2b-packagers.update');
