...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::post('search', 'SearchRoutingController@index')->name('search');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            //db clean - DISABLED FOR SECURITY
            ...
            Route::group(['prefix' => 'module', 'as' => 'module.'], function () {
                ...
                Route::get('store', 'ModuleController@getAddView')->name('create');
                Route::post('store', 'ModuleController@add')->name('store');
                Route::get('edit/{id}', 'ModuleController@getUpdateView')->name('edit');
                Route::put('edit/{id}', 'ModuleController@update')->name('update');
                Route::get('status/{id}/{status}', 'ModuleController@updateStatus')->name('status');
                Route::get('type', 'ModuleController@getType')->name('type');
                Route::post('search', 'ModuleController@search')->name('search');
                Route::get('export', 'ModuleController@exportList')->name('export');
