...
class POSController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        if($product->module->module_type == 'food'){
            ...
            $data['price'] = $this->getB2BPrice($product, null);
    ...
    public function place_order(Request $request)
    {
        ...
        $order->order_amount = $total_price + $tax_a + $order->additional_charge + $order->delivery_charge;
        ...
        if ($order->payment_method === 'postpaid') {
            ...
            $order->order_amount = $total_price + $tax_a + $order->additional_charge;
        }
        ...
        try {
            ...
            // Stock will only be deducted when order moves to processing status
