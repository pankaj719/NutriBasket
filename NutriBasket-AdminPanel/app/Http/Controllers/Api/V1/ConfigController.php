...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        // Add Postpaid payment method
        $active_addon_payment_lists[] = [
            'gateway' => 'postpaid',
            'gateway_title' => 'Postpaid',
            'gateway_image' => null, // You can set an image path if available
            'gateway_image_full_url' => null, // You can set a full URL if available
            'delivery_charge' => 0 // Custom field for delivery charge, for now 0
        ];
