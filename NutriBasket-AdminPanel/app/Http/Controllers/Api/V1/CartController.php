...
class CartController extends Controller
{
    public function get_carts(Request $request)
    {
        ...
        ->map(function ($data) {
            ...
            // Ensure the cart's price (which includes B2B pricing) is preserved
...
//            }
        ...
        // Calculate the correct price using getB2BPrice to include B2B pricing
        $cart->price = $this->getB2BPrice($item, $request->user);
    ...
    private function getB2BPrice($item, $user)
    {
        if ($user && $user->user_type === 'b2b') {
            ...
            if (isset($item->b2b_price)) {
                return $item->b2b_price;
            }
        }
        return $item->price;
    }
