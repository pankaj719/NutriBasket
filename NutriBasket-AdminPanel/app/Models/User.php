...
class User extends Authenticatable
{
    ...
    public function b2bClients()
    {
        return $this->belongsToMany(\App\Models\B2BClient::class, 'b2b_client_user', 'user_id', 'b2b_client_id');
    }

    public function b2bClient()
    {
        return $this->belongsTo(\App\Models\B2BClient::class, 'b2b_client_id');
    }
    ...
    public function getActiveClientContract()
    {
        $client = $this->b2bClients()->first();
        if ($client) {
            return $client->contracts()->where('status', 'active')->first();
        }
        return null;
    }
