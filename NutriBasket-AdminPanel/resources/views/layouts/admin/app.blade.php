...
"use strict";
   ...
   messaging.onMessage(function(payload) {
       ...
       if(payload.data.order_id && payload.data.type == "order_request"){
               ...
               new_is_b2b = payload.data.is_b2b === 'true' || payload.data.is_b2b === true || payload.data.is_b2b === 1 || payload.data.is_b2b === '1'
               console.log('Firebase notification - is_b2b:', payload.data.is_b2b, 'processed:', new_is_b2b);
           ...
           setInterval(function () {
               $.get({
                   ...
                   success: function (response) {
                       ...
                       new_is_b2b = data.is_b2b === 'true' || data.is_b2b === true || data.is_b2b === 1 || data.is_b2b === '1';
                       console.log('Manual notification - is_b2b:', data.is_b2b, 'processed:', new_is_b2b);
                       if(new_order_type === 'trip'){
                           document.querySelector('.update_notification_text').textContent = "{{translate('messages.You have new trip, Check Please.')}}";
                       }
                       if (data.new_order > 0) {
   ...
   $(document).on('click', '.check-order', function () {
       ...
       {
           // Check if this is a B2B order and navigate to B2B pending orders
           console.log('Click handler - new_is_b2b:', new_is_b2b, 'type:', typeof new_is_b2b);
           if (typeof new_is_b2b !== 'undefined' && (new_is_b2b === true || new_is_b2b === 'true' || new_is_b2b === 1 || new_is_b2b === '1')) {
               console.log('Navigating to B2B pending orders');
               location.href = '{{route('admin.b2b-order.list', ['pending'])}}?module_id=' + new_module_id;
           } else {
               console.log('Navigating to regular all orders');
