...
<li class="nav-item">
    <small class="nav-subtitle">{{ translate('B2B') }}</small>
    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
</li>
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/b2b-order*') ? 'active' : '' }}">
    ...
    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/b2b-order*') ? 'block' : 'none' }}">
        ...
        <li class="nav-item {{ Request::is('admin/b2b-order/list/preparing') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['preparing']) }}">Preparing</a>
        </li>
        ...
        <li class="nav-item {{ Request::is('admin/b2b-order/list/manager_packaged') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['manager_packaged']) }}">B2B Packagers</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/manager_deliveryman') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['manager_deliveryman']) }}">B2B Deliveryman</a>
        </li>
...
<!-- B2B Packagers -->
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b-packagers*') ? 'active' : '' }}">
    ...
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.change_requests.index') }}" title="Change Requests">
        ...
        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
            Change Requests
                ...
                {{-- Clean Database menu item removed for security --}}
                {{--
