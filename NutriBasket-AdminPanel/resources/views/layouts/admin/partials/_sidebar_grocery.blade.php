...
<li class="nav-item">
    <small class="nav-subtitle">{{ translate('B2B Management') }}</small>
    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
</li>
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/b2b-order*') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:;" title="B2B Orders">
        <i class="tio-briefcase nav-icon"></i>
        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
            B2B Orders
        </span>
    </a>
    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/b2b-order*') ? 'block' : 'none' }}">
        <li class="nav-item {{ Request::is('admin/b2b-order/list/all') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['all']) }}">All</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/pending') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['pending']) }}">Pending</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/processing') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['processing']) }}">Processing</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/accepted') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['accepted']) }}">Accepted</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/packaging') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['packaging']) }}">Packaging</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/on_the_way') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['on_the_way']) }}">On My Way</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/delivered') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['delivered']) }}">Delivered</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/acknowledged') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['acknowledged']) }}">Acknowledged</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/canceled') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['canceled']) }}">Cancelled</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/failed') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['failed']) }}">Payment Failed</a>
        </li>
        <li class="nav-item {{ Request::is('admin/b2b-order/list/refunded') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.b2b-order.list', ['refunded']) }}">Refunded</a>
        </li>
    </ul>
</li>

<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b*') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.b2b') }}" title="B2B Managers">
        <i class="tio-briefcase nav-icon"></i>
        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
            B2B Managers
        </span>
...
<!-- B2B Clients -->
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/b2b-clients*') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.b2b.clients.index') }}" title="B2B Clients">
...
<!-- B2B Contracts -->
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/b2b-clients/contracts*') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.b2b.clients.contracts') }}" title="B2B Contracts">
...
<!-- B2B Templates -->
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b-templates*') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.b2b-templates.index') }}" title="B2B Templates">
...
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/b2b-packagers*') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.b2b-packagers.index') }}" title="B2B Packagers">
...
<!-- B2B Invoices -->
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/b2b-invoices*') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.b2b-invoices.index') }}" title="B2B Invoices">
...
<!-- Change Requests -->
<li class="navbar-vertical-aside-has-menu {{ Request::is('admin/change-requests') ? 'active' : '' }}">
    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.change_requests.index') }}" title="Change Requests">
        ...
        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
            Change Requests
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle">{{ translate('Inventory Management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>

                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/inventory*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="Inventory Management">
                            <i class="tio-inventory nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                Inventory Management
                            </span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/inventory*') ? 'block' : 'none' }}">
                            ...
                            <li class="nav-item {{ Request::is('admin/inventory/purchase*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.inventory.purchase.index') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">Purchase Management</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('admin/inventory/wastage*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.inventory.wastage.index') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">Wastage Management</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('admin/inventory/vendor*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.inventory.vendor.index') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">Vendor Management</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('admin/inventory/category*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.inventory.category.index') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">Wastage Categories</span>
                                </a>
                            </li>
                        </ul>
                    </li>
