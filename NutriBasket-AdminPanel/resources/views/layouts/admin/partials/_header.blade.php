            ...
            <div class="navbar-nav-wrap-content-right flex-grow-1 w-0">
                ...
                <ul class="navbar-nav align-items-center flex-row flex-grow-1 __navbar-nav">
                    ...
                    <li class="nav-item __nav-item">
                        <a href="{{ route('admin.dashboard')}}" id="tourb-home"
                           class="__nav-link {{ Request::is('admin') ? 'active' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#006161" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house-icon lucide-house">
