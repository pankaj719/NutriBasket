        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- B2B Section - Moved to B2B Orders section -->
                    <!-- B2B user management and Change Requests are now available under the main B2B Orders section -->
                ...
                <!-- B2B User Management -->
                <li class="nav-item">
                    <small class="nav-subtitle" title="B2B User Management">B2B User Management</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>
                
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b') && !Request::is('admin/users/b2b-*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b-clients') || Request::is('admin/users/b2b-clients/index') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b-clients/contracts') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b-packagers') || Request::is('admin/users/b2b-packagers/index') ? 'active' : '' }}">
                ...
                <!-- <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/b2b') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.b2b') }}" title="B2B Users">
                        <i class="tio-briefcase nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            B2B Users
                        </span>
