        ...
        <div>
            ...
            <div class="print--invoice initial-38-1">
                ...
                @if($order->quantity_modified)
                    <div class="modification-notice text-center mb-3">
                        <div class="alert alert-warning d-inline-block">
                            <strong>⚠️ Order Modified</strong><br>
                            <small>Modified on {{ $order->modified_at ? date('d M Y H:i', strtotime($order->modified_at)) : 'N/A' }}
                            ...
                            @else
                                ...
                                @foreach ($order->details as $detail)
                                    ...
                                    <td class="w-28p">
                                        @if($detail['is_na'])
                                            @php($amount = 0)
                                            <span class="text-danger font-weight-bold">{{ \App\CentralLogics\Helpers::format_currency(0) }}</span>
                                        @else
