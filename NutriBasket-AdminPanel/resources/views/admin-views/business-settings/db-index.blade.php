...
<div class="content container-fluid">
    ...
    <!-- End Page Header -->
        ...
        <div class="card">
            <div class="card-body">
                {{-- FORM DISABLED FOR SECURITY - Clean database functionality removed --}}
                {{-- <form action="{{route('admin.business-settings.clean-db')}}" method="post"
                      enctype="multipart/form-data"> --}}
                <form action="#" method="post" enctype="multipart/form-data" style="pointer-events: none; opacity: 0.5;">
                    @csrf
                    <div class="alert alert-warning">
                        <strong>Notice:</strong> Database cleaning functionality has been disabled for security reasons.
                    </div>
                    ...
                    <div class="btn--container justify-content-end mt-4">
                        <button type="reset" class="btn btn--reset" disabled>{{translate('messages.reset')}}</button>
                        <button type="button" class="btn btn--primary call-demo" disabled>{{translate('Clear')}} (Disabled)</button>
                    </div>
                </form>
            </div>
        </div>
