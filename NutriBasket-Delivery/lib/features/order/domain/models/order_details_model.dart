class OrderDetailsModel {
  ...
  int? vendorId;
  String? changeRequestStatus; // <-- Add this line
  ...
  OrderDetailsModel({
    ...
    this.vendorId,
    this.changeRequestStatus, // <-- Add this param
  });
  ...
  OrderDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    changeRequestStatus = json['change_request_status']; // <-- Add this line
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['change_request_status'] = changeRequestStatus; // <-- Add this line
    return data;
  }
}
