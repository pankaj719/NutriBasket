...
// TODO: Replace with the actual import path if baseUrl is defined elsewhere
const String baseUrl = 'https://backend.nutribasket.in';
...
class OrderService implements OrderServiceInterface {
  ...
  Future<void> requestQuantityChange({
    ...
    await orderRepositoryInterface.requestQuantityChange(
      orderId: orderId,
      itemId: itemId,
  ...
  Future<void> requestBulkQuantityChange({
    ...
    await orderRepositoryInterface.requestBulkQuantityChange(
      orderId: orderId,
      changes: changes,
    );
  }
