...
class OrderController extends GetxController implements GetxService {
  ...
  Future<void> requestQuantityChange({
    ...
    await orderServiceInterface.requestQuantityChange(
      orderId: orderId,
      itemId: itemId,
      newQuantity: newQuantity,
      reason: reason,
    );
    // Optionally refresh order details or show a snackbar
    update();
  }
  ...
  Future<void> requestBulkQuantityChange({
    ...
    await orderServiceInterface.requestBulkQuantityChange(
      orderId: orderId,
      changes: changes,
    );
    update();
