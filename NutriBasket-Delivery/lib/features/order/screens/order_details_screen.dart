...
import 'package:sixam_mart_delivery/features/order/widgets/edit_all_quantities_dialog.dart';
                      ...
                      Expanded(
                        ...
                        child: Column(children: [
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (changes != null &&
                                          ...
                                          await orderController
                                              .requestBulkQuantityChange(
                                            orderId: controllerOrderModel.id
                                                .toString(),
                                            changes: changes,
                                          );
                                          showCustomSnackBar(
                                              'Bulk change request submitted',
                                              isError: false);
                                        }
                                      },
                                      child: Text('Edit All Quantities'),
                                    ),
                                    ListView.builder(
                                      shrinkWrap: true,
                                      physics:
                          ...
                          (Get.find<SplashController>()
                                      ...
                                      .orderAttachment! &&
                                  controllerOrderModel.orderAttachmentFullUrl !=
                                      null &&
                                  controllerOrderModel
