              ...
              child:
                ...
                return Column(children: [
                  GetBuilder<OrderController>(builder: (orderController) {
                    return Column(children: [
                      orderController.assignedOrderList == null
                          ? OrderShimmerWidget(isEnabled: true)
                          : orderController.assignedOrderList!.isNotEmpty
                              ? Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    TitleWidget(title: 'assigned_orders'.tr),
                                    ListView.builder(
                                      shrinkWrap: true,
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                      itemCount: orderController
                                          .assignedOrderList!.length,
                                      itemBuilder: (context, index) {
                                        return OrderWidget(
                                          orderModel: orderController
                                              .assignedOrderList![index],
                  ...
                  //           crossAxisAlignment: profileController
                  ...
                  //                               .profileModel!.cashInHands),
                  //                       style:
                  //                           robotoBold.copyWith(fontSize: 30)),
                  //                   const SizedBox(
                  //                       width: Dimensions.paddingSizeSmall),
