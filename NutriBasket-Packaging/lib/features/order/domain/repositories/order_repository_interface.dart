...
abstract class OrderRepositoryInterface implements RepositoryInterface {
  ...
  Future<dynamic> getAssignedOrders();
  Future<dynamic> getOrdersByStatus(String status);
  Future<dynamic> getPackagingOrders();
  Future<dynamic> getPickedUpOrders();
  Future<dynamic> getPackagerOrderDetails(int orderId);
  Future<dynamic> updatePackagerOrderStatus(Map<String, dynamic> body);
}
