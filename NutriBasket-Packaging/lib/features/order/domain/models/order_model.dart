...
class OrderModel {
  ...
  Map<String, dynamic>? assignedDeliveryMan;
  Map<String, dynamic>? assignedPackager;
  List<dynamic>? items;
  StoreModel? storeModel;
  SimpleUserModel? assignedDeliveryManModel;
  SimpleUserModel? assignedPackagerModel;
  ...
  OrderModel({
    ...
    this.items,
    this.storeModel,
    this.assignedDeliveryManModel,
    this.assignedPackagerModel,
    this.itemModels,
  });
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    store = json['store'];
    assignedDeliveryMan = json['assigned_delivery_man'];
    assignedPackager = json['assigned_packager'];
    items = json['items'];
    storeModel =
        json['store'] != null ? StoreModel.fromJson(json['store']) : null;
    assignedDeliveryManModel = json['assigned_delivery_man'] != null
        ? SimpleUserModel.fromJson(json['assigned_delivery_man'])
        : null;
    assignedPackagerModel = json['assigned_packager'] != null
        ? SimpleUserModel.fromJson(json['assigned_packager'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['store'] = store;
    data['assigned_delivery_man'] = assignedDeliveryMan;
    data['assigned_packager'] = assignedPackager;
    data['items'] = items;
    data['store_model'] = storeModel?.toJson();
    data['assigned_delivery_man_model'] = assignedDeliveryManModel?.toJson();
    data['assigned_packager_model'] = assignedPackagerModel?.toJson();
    data['item_models'] = itemModels?.map((v) => v.toJson()).toList();
    return data;
  }
}
...
class SimpleUserModel {
  ...
  SimpleUserModel({this.id, this.name, this.phone, this.email});
...
class StoreModel {
  ...
  StoreModel({this.id, this.name, this.address, this.phone});
