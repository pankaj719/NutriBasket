...
class OrderService implements OrderServiceInterface {
  ...
  // New Packager Endpoints
  Future<List<OrderModel>?> getAssignedOrders() async {
    return await orderRepositoryInterface.getAssignedOrders();
  }

  Future<List<OrderModel>?> getOrdersByStatus(String status) async {
    return await orderRepositoryInterface.getOrdersByStatus(status);
  }

  Future<List<OrderModel>?> getPackagingOrders() async {
    return await orderRepositoryInterface.getPackagingOrders();
  }

  Future<List<OrderModel>?> getPickedUpOrders() async {
    return await orderRepositoryInterface.getPickedUpOrders();
  }

  Future<Response> getPackagerOrderDetails(int orderId) async {
    return await orderRepositoryInterface.getPackagerOrderDetails(orderId);
  }

  Future<ResponseModel> updatePackagerOrderStatus(
      Map<String, dynamic> body) async {
    return await orderRepositoryInterface.updatePackagerOrderStatus(body);
  }
}
