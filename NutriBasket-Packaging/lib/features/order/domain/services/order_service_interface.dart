...
abstract class OrderServiceInterface {
  ...
  Future<List<OrderModel>?> getPackagingOrders();
  Future<List<OrderModel>?> getPickedUpOrders();
  Future<Response> getPackagerOrderDetails(int orderId);
  Future<ResponseModel> updatePackagerOrderStatus(Map<String, dynamic> body);
}
