...
class ProfileRepository implements ProfileRepositoryInterface {
  ...
  Future<void> recordWebSocketLocation(
    ...
    // Disable location tracking for packagers
    // recordLocationBody.token = _getUserToken();
    // String uri =
    //     '${Get.find<SplashController>().configModel!.webSocketUri!}:${Get.find<SplashController>().configModel!.webSocketPort!}/packager/live-location?appKey=${Get.find<SplashController>().configModel!.webSocketKey!}';
  ...
  Future<Response> recordLocation(RecordLocationBodyModel recordLocationBody) {
    ...
    return Future.value(Response(
        statusCode: 200,
        body: {'message': 'Location tracking disabled for packagers'}));
  }
