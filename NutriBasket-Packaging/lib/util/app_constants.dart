...
class AppConstants {
  static const String appName = 'NutriBasket Packaging';
  ...
  static const String forgetPasswordUri =
      '/api/v1/auth/packager/forgot-password';
  static const String verifyTokenUri = '/api/v1/auth/packager/verify-token';
  static const String resetPasswordUri = '/api/v1/auth/packager/reset-password';
  static const String loginUri = '/api/v1/auth/packager/login';
  static const String tokenUri = '/api/v1/packager/update-fcm-token';
  // static const String recordLocationUri =
  //     '/api/v1/auth/packager/record-location';
  static const String profileUri = '/api/v1/auth/packager/profile?token=';
  static const String updateOrderStatusUri =
      '/api/v1/packager/update-order-status';
  static const String updatePaymentStatusUri =
      '/api/v1/packager/update-payment-status';
  static const String acceptOrderUri = '/api/v1/packager/accept-order';
  static const String activeStatusUri = '/api/v1/packager/update-active-status';
  static const String updateProfileUri = '/api/v1/packager/update-profile';
  static const String notificationUri = '/api/v1/packager/notifications?token=';
  ...
  static const String driverRemoveUri =
      '/api/v1/packager/remove-account?token=';
  static const String dmRegisterUri = '/api/v1/auth/packager/store';
  ...
  static const String deliveredOrderNotificationUri =
      '/api/v1/packager/send-order-otp';
  static const String addWithdrawMethodUri =
      '/api/v1/packager/withdraw-method/store';
  static const String disbursementMethodListUri =
      '/api/v1/packager/withdraw-method/list';
  static const String makeDefaultDisbursementMethodUri =
      '/api/v1/packager/withdraw-method/make-default';
  static const String deleteDisbursementMethodUri =
      '/api/v1/packager/withdraw-method/delete';
  static const String getDisbursementReportUri =
      '/api/v1/packager/get-disbursement-report';
  static const String withdrawRequestMethodUri =
      '/api/v1/packager/get-withdraw-method-list';
  static const String makeCollectedCashPaymentUri =
      '/api/v1/packager/make-collected-cash-payment';
  static const String walletPaymentListUri =
      '/api/v1/packager/wallet-payment-list';
  static const String makeWalletAdjustmentUri =
      '/api/v1/packager/make-wallet-adjustment';
  static const String walletProvidedEarningListUri =
      '/api/v1/packager/wallet-provided-earning-list';
  static const String firebaseAuthVerify =
      '/api/v1/auth/packager/firebase-verify-token';

  ///chat url
  static const String getConversationListUri = '/api/v1/packager/message/list';
  static const String getMessageListUri = '/api/v1/packager/message/details';
  static const String sendMessageUri = '/api/v1/packager/message/send';
  static const String searchConversationListUri =
      '/api/v1/packager/message/search-list';
  ...
  /// Packager-specific endpoints
  static const String packagerOrdersUri = '/api/v1/auth/packager/orders';
  static const String packagerOrdersByStatusUri =
      '/api/v1/auth/packager/orders/status/';
  static const String packagerPackagingOrdersUri =
      '/api/v1/auth/packager/orders/packaging';
  static const String packagerPickedUpOrdersUri =
      '/api/v1/auth/packager/orders/picked_up';
  static const String packagerOrderDetailsUri = '/api/v1/auth/packager/order/';
  static const String packagerOrderUpdateStatusUri =
      '/api/v1/auth/packager/order/update-status';
}
